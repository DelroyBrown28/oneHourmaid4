...
## UX
oneHourmaid was designed for working people or families that may not have the time to focus on basic house chores. oneHourmaid can take care of all your in home cleaning needs quickly and effeciently. The app was made to be simple and straightforward as to remain relevant amongst all audiences. Although intended for mobile view, the app works just as well in desktop view. Designed in Figma, oneHourmaid keeps to a clean black and gold theme throughout, although designed for mobile view the app is responsive to iPads and desktop views also.
